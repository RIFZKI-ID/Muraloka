...
class HomeCubit extends Cubit<HomeState> {
  ...
  void fetchData() async {
    ...
    try {
      final resumeProjects = await FirestoreService()
          .getProjectsByVisibility('private')
          .first;
      final popularProjects = await FirestoreService()
          .getProjectsByVisibility('public')
          .first;
      final popularAuthors = await FirestoreService().fetchUsers();
      ...
      emit(HomeFailure('Gagal memuat data beranda: $e'));
    }
  }
}
